...
data class Location (
    ...
    var climateThisYear: Int = (-5..5).random() //-5 to 5 //fog 1
    ...
    fun showAllData(): String{
        ...
        s+= "\n Fert $fertility Abun $abundance Starv $starvation Climate $climateThisYear"
        s+= "\n Barbs $barbarianRaids Crime $crimeInfluence Church $churchInfluence Fog $fogOfWar"
        return s
    }
